...
<main id="main" class="main">
        ...
        <?php 
               ...
               ?>
               <form action="updating/updateroomnum.php" method="POST">
                <div>
               ...
               <form action="updating/updateroomtype.php" method="POST">
                <div>
               ...
               <?php
                ...
                ?>
                <form action="updating/updatenumberofbeds.php" method="POST">
                    <div>
                ...
                <form action="updating/updatenumberofroom.php" method="POST">
                    <div>
                ...
                <?php } ?>
               <form action="updating/updateroomstatus.php" method="POST">
                <div>
               ...
               <form action="updating/updateroomsalary.php" method="POST">
                <div>
                    old value : <?php echo $row['roomprice']?>
                </div>
               ...
               <form action="updating/updatecheckin.php" method="POST">
                <div>
               ...
               <form action="updating/updatecheckout.php" method="POST">
                <div>
